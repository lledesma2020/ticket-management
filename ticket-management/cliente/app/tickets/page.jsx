...
export default function TicketManagement() {
  ...
  const getStatusStyles = (status) => {
    switch (status) {
      case "Nuevo":
        return { backgroundColor: "#e6f7ed", color: "#388e3c", padding: "4px 8px", borderRadius: "12px", fontWeight: "500", display: "inline-block" }; // Light Green, pill shape
      case "Autorizando":
        return { backgroundColor: "#e0f2f7", color: "#2196f3", padding: "4px 8px", borderRadius: "12px", fontWeight: "500", display: "inline-block" }; // Light Blue, pill shape
      case "En curso":
        return { backgroundColor: "#fff3e0", color: "#f57c00", padding: "4px 8px", borderRadius: "12px", fontWeight: "500", display: "inline-block" }; // Light Orange, pill shape
      case "Finalizado":
        return { backgroundColor: "#f0f0f0", color: "#757575", padding: "4px 8px", borderRadius: "12px", fontWeight: "500", display: "inline-block" }; // Light Gray, pill shape
      case "Rechazado":
        return { backgroundColor: "#ffebee", color: "#d32f2f", padding: "4px 8px", borderRadius: "12px", fontWeight: "500", display: "inline-block" }; // Light Red, pill shape
      default:
      ...
      <div style={{ flex: 1, padding: "24px", paddingTop: "80px" }}>
        ...
        <div className="table-container">
          <table className="table">
            <thead>
              <tr>
                <th>ID</th> {/* Changed from ID de Incidencia to ID */}
                <th>Sector</th>
                <th>Solicitante</th>
                <th>Gestor</th>
                <th>Estado</th>
            ...
            <tbody>
              {filteredTickets.length === 0 ? (
                <tr><td colSpan={6} className="table-empty-message">
                ...
                filteredTickets.map((ticket) => (
                  <tr
                    ...
                    onClick={() => window.location.href = `/tickets/${ticket.idIncidencia}`}
